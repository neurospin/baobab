...
<section id="banner">
<div class="content">
 <p class=MsoNormal><b><span lang=EN-US>The BAOBAB UMR is the methodological
backbone of the NeuroSpin large-scale imaging facility, supporting the R&amp;D
necessary for cutting-edge MRI technology.</span></b><span lang=EN-US>
...
<p class=MsoNormal><span lang=EN-US>Other instruments at NeuroSpin serve
...
<p class=MsoNormal><b><span lang=EN-US>BAOBAB also plays a major role in the
national CATI platform</span></b><span lang=EN-US>, a distributed neuroimaging
...
<p class=MsoNormal><span lang=EN-US>This dual involvement significantly shapes
BAOBAB’s research priorities, allowing the unit to combine the two major
strategies in neuroscience imaging: <b>deep phenotyping</b>, enabled by
